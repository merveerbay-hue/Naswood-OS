...
public sealed class Shift : BusinessEntity
{
    private Shift() { }

    private Shift(Guid id, string code, string name, string status, string notes, string companyId, string? plantId)
        : base(id)
    {
        Code = code;
        Name = name;
    ...
    public static Shift Create(string code, string name, string status, string notes, string companyId = "COMP-001", string? plantId = "PLANT-001")
