...
public sealed class Scrap : BusinessEntity
{
    private Scrap() { }

    private Scrap(Guid id, string code, string name, string status, string notes, string companyId, string? plantId)
        : base(id)
    {
        Code = code;
        Name = name;
    ...
    public static Scrap Create(string code, string name, string status, string notes, string companyId = "COMP-001", string? plantId = "PLANT-001")
