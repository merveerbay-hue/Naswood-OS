...
public sealed class Tooling : BusinessEntity
{
    private Tooling() { }

    private Tooling(Guid id, string code, string name, string status, string notes, string companyId, string? plantId)
        : base(id)
    {
        Code = code;
        Name = name;
    ...
    public static Tooling Create(string code, string name, string status, string notes, string companyId = "COMP-001", string? plantId = "PLANT-001")
