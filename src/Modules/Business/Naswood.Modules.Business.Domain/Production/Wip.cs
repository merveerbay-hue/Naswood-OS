...
public sealed class Wip : BusinessEntity
{
    private Wip() { }

    private Wip(Guid id, string code, string name, string status, string notes, string companyId, string? plantId)
        : base(id)
    {
        Code = code;
        Name = name;
    ...
    public static Wip Create(string code, string name, string status, string notes, string companyId = "COMP-001", string? plantId = "PLANT-001")
