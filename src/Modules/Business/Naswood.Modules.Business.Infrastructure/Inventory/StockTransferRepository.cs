...
public sealed class StockTransferRepository : IStockTransferRepository
{
    ...
    public async Task<(IReadOnlyList<StockTransfer> Items, int Total)> SearchAsync(string? q, int page, int pageSize, string? plantId = null, CancellationToken cancellationToken = default)
    {
