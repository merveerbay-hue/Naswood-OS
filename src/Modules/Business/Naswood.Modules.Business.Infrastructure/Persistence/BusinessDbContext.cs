...
public sealed class BusinessDbContext : DbContext
{
    ...
    public DbSet<Naswood.Modules.Business.Domain.Production.StructuralProductionLot> StructuralProductionLots => Set<Naswood.Modules.Business.Domain.Production.StructuralProductionLot>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Naswood.Modules.Business.Domain.Inventory.Warehouse>(entity =>
        {
            ...
            entity.Property(x => x.Status).HasMaxLength(200);
            entity.HasIndex(x => new { x.PlantId, x.Code });
        });
        ...
        modelBuilder.Entity<Naswood.Modules.Business.Domain.Inventory.MaterialIdentity>(entity =>
        {
            entity.ToTable("business_inventory_materialidentity");
            entity.HasKey(x => x.Id);
            entity.Property(x => x.CompanyId).HasMaxLength(20).IsRequired();
            entity.Property(x => x.PlantId).HasMaxLength(20);
            entity.Ignore(x => x.DomainEvents);
            entity.Property(x => x.IdentityNumber).HasMaxLength(200);
            entity.Property(x => x.MaterialCode).HasMaxLength(200);
            ...
            entity.Property(x => x.RootGoodsReceiptNumber).HasMaxLength(200);
            entity.HasIndex(x => x.IdentityNumber);
        });

        modelBuilder.Entity<Naswood.Modules.Business.Domain.Inventory.InventoryPackage>(entity =>
        {
            entity.ToTable("business_inventory_package");
            entity.HasKey(x => x.Id);
            entity.Property(x => x.CompanyId).HasMaxLength(20).IsRequired();
            entity.Property(x => x.PlantId).HasMaxLength(20);
            entity.Ignore(x => x.DomainEvents);
        ...
        {
            entity.ToTable("business_inventory_movement");
            entity.HasKey(x => x.Id);
            entity.Property(x => x.CompanyId).HasMaxLength(20).IsRequired();
            entity.Property(x => x.PlantId).HasMaxLength(20);
            entity.Ignore(x => x.DomainEvents);
            entity.Property(x => x.MovementNumber).HasMaxLength(200);
            entity.Property(x => x.MovementType).HasMaxLength(50);
            entity.Property(x => x.Direction).HasMaxLength(10);
            entity.Property(x => x.DocumentNumber).HasMaxLength(200);
            entity.Property(x => x.MaterialCode).HasMaxLength(200);
            entity.Property(x => x.MaterialIdentityNumber).HasMaxLength(200);
            entity.Property(x => x.PackageNumber).HasMaxLength(200);
            entity.Property(x => x.WarehouseCode).HasMaxLength(200);
        ...
        modelBuilder.Entity<Naswood.Modules.Business.Domain.Production.StructuralProductionLot>(entity =>
        {
            entity.ToTable("business_production_structural_production_lot");
            entity.HasKey(x => x.Id);
            entity.Property(x => x.CompanyId).HasMaxLength(20).IsRequired();
            entity.Property(x => x.PlantId).HasMaxLength(20);
            entity.Ignore(x => x.DomainEvents);
            entity.Property(x => x.ProductionLotNumber).HasMaxLength(80).IsRequired();
            entity.Property(x => x.MaterialCode).HasMaxLength(200);
            entity.Property(x => x.ActualGradingMethod).HasMaxLength(40);
            entity.Property(x => x.WorkCenterCode).HasMaxLength(200);
            entity.Property(x => x.ShiftCode).HasMaxLength(80);
            entity.Property(x => x.Status).HasMaxLength(40);
            entity.Property(x => x.Notes).HasColumnType("text");
            entity.Property(x => x.CreatedBy).HasMaxLength(200);
            entity.Property(x => x.ReleasedBy).HasMaxLength(200);
        ...
        {
            entity.ToTable("business_production_structural_production_lot_input");
            entity.HasKey(x => x.Id);
            entity.Property(x => x.Unit).HasMaxLength(40);
            entity.HasIndex(x => x.ProductionLotId);
        });

        modelBuilder.Entity<Naswood.Modules.Business.Domain.Production.ProductionOutput>(entity =>
        {
            entity.ToTable("business_production_output");
            entity.HasKey(x => x.Id);
            entity.Property(x => x.CompanyId).HasMaxLength(20).IsRequired();
            entity.Property(x => x.PlantId).HasMaxLength(20);
            entity.Ignore(x => x.DomainEvents);
            entity.Property(x => x.Number).HasMaxLength(80);
            entity.Property(x => x.OutputMaterialCode).HasMaxLength(200);
            entity.Property(x => x.WarehouseCode).HasMaxLength(200);
            entity.Property(x => x.LocationCode).HasMaxLength(200);
            entity.Property(x => x.WorkCenterCode).HasMaxLength(80);
            entity.Property(x => x.StockStatus).HasMaxLength(40);
            entity.Property(x => x.Status).HasMaxLength(40);
        ...
        {
            entity.ToTable("business_production_lot_source");
            entity.HasKey(x => x.Id);
            entity.Property(x => x.CompanyId).HasMaxLength(20).IsRequired();
            entity.Property(x => x.PlantId).HasMaxLength(20);
            entity.Ignore(x => x.DomainEvents);
