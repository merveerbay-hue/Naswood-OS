...
| **Material Definition Architecture** | `99_Shared/Material_Definition_Architecture.md` | **Landed** — active Definition (not passive Master card); Materials/Material.md consumers; distinct from MI & Product |
