...
| **Material Definition Architecture** (active material rule pack — Identity · Measurement · Conversion · Packaging · Numbering · Quality · Traceability · Costing; not passive Material Master card) | [`docs/13_Design/99_Shared/Material_Definition_Architecture.md`](../13_Design/99_Shared/Material_Definition_Architecture.md) | Materials module, all ops modules, Conversion Engine bindings — **do not** design Code·Name·Save Material CRUD; legacy `Material.md` “Material Master” = Definition |
| **Measurement & Conversion Architecture** (Primary/Secondary UoM · Formula Engine · wood conversions · precision/rounding composition) | [`docs/13_Design/99_Shared/Measurement_Conversion_Architecture.md`](../13_Design/99_Shared/Measurement_Conversion_Architecture.md) | All quantity modules — Engine doc is the runtime contract under this architecture |
| **Compliance Architecture** (ISO/TSE/FSC/PEFC · audit · revision · evidence · e-sign · immutable/reverse) | [`docs/13_Design/99_Shared/Compliance_Architecture.md`](../13_Design/99_Shared/Compliance_Architecture.md) | All Posting modules — compose Audit_Log / Approval / Evidence; Workbench Design Standard = ops UX |
| **Inventory Foundation Program** (core architecture sequence before more screens) | [`docs/13_Design/02_Inventory/Inventory_Foundation_Program.md`](../13_Design/02_Inventory/Inventory_Foundation_Program.md) | Pauses ops Design Program until GATE F1; tracks Warehouse / Transaction Engine / Package Architecture |
...
| **Package Allocation Workspace** (shared interactive package select/allocate UX for all stock movements) | [`docs/13_Design/99_Shared/Package_Allocation_Workspace.md`](../13_Design/99_Shared/Package_Allocation_Workspace.md) | Goods Issue · Receiving verify/count · Transfer · Production consumption · Shipping · Inventory Count — **one language**; process PRDs compose, do not fork parallel grids |
| **Inventory Workbench Design Standard** (COMPLIANCE BY DESIGN — ops Workbench philosophy, audit/revision/approvals composition, immutable posted txns, canonical package columns/status) | [`docs/13_Design/99_Shared/Inventory_Workbench_Design_Standard.md`](../13_Design/99_Shared/Inventory_Workbench_Design_Standard.md) | Goods Issue · Receiving · future Inventory Workbenches — **do not** redefine compliance/audit/immutable laws in Screens; engines stay in `Audit_Log.md` / `Approval_Workflow.md` |
| **Measurement & Conversion Engine** (centralized multi-UoM: enter once · display pcs/lm/m²/m³/kg/t · dimensional/density/package/custom formulas) | [`docs/13_Design/99_Shared/Measurement_Conversion_Engine.md`](../13_Design/99_Shared/Measurement_Conversion_Engine.md) | Inventory · Production · Purchasing · Sales · Planning · Costing · Quality · Shipping — **no** module-local conversion math; SI/precision stay in `Measurement_System.md`; unit-pair factors in `Unit_Conversion.md` |
...
| **Measurement & Conversion Engine** | `99_Shared/Measurement_Conversion_Engine.md` | **Landed** — centralized multi-UoM; composes `Measurement_System.md` + `Unit_Conversion.md` |
| **Material Definition Architecture** | `99_Shared/Material_Definition_Architecture.md` | **Landed v1.1** — full attribute catalog; Foundation #1 |
| **Measurement & Conversion Architecture** | `99_Shared/Measurement_Conversion_Architecture.md` | **Landed v1.0** — Foundation #2; Engine = runtime contract |
| **Material Identity Architecture** | `99_Shared/Material_Identity_Architecture.md` | **Landed v1.1** — identity family; Foundation #3 |
